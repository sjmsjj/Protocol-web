"""
WSGI config for protocol project.
...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "protocol.settings")
...
# # web application at http://protocolgo.pythonanywhere.com/
...
# #import sys
# #
# #path = '/home/protocolgo/path/to/my/app
...
# #import sys
# #
# ## assuming your django settings file is at '/home/protocolgo/mysite/mysite/settings.py'
# ## and your manage.py is is at '/home/protocolgo/mysite/manage.py'
# #path = '/home/protocolgo/mysite'
# #if path not in sys.path:
# #    sys.path.append(path)
# #
...
# #import sys
# #
# ## The "/home/protocolgo" below specifies your home
# ## directory -- the rest should be the directory you uploaded your Flask
# ## code to underneath the home directory.  So if you just ran
# ## "git clone git@github.com/myusername/myproject.git"
# ## ...or uploaded files to the directory "myproject", then you should
# ## specify "/home/protocolgo/myproject"
# #path = '/home/protocolgo/path/to/flask_app_directory'
# #if path not in sys.path:
# #    sys.path.append(path)
# #
